#> origins-unknown-beings:warper/particle_relocation/cast
#
...
execute at @s positioned ^ ^ ^1.0 run function origins-unknown-beings:warper/particle_relocation/distance/set_max
