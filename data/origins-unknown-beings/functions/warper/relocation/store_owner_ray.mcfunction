#> origins-unknown-beings:warper/relocation/store_owner_ray
#
...
function origins-unknown-beings:warper/relocation/reset
...
execute as @a run function origins-unknown-beings:warper/relocation/store_uuid_player