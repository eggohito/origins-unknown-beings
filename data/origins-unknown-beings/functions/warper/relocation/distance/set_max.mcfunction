#> origins-unknown-beings:warper/relocation/distance/set_max
#
...
execute if score #blocks o-u-b.WP matches 1.. positioned ^ ^ ^1 run function origins-unknown-beings:warper/relocation/distance/set_max